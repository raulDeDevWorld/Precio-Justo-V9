...
function Home() {
    ...
    const registerHandler = (e) => {
        ...
        readUserData('Users', user.user.id, userDB, setUserData)
    }
            ...
            <main className={style.main}>
                ...
                >
                    <form className="space-y-6" onSubmit={registerHandler} >
                        ...
                        <div>
                            <label htmlFor="email" className="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-white">Tipo de cuenta</label>
                            <Select arr={['Cliente', 'Medico', 'Clinica', 'Distribuidor']} name='rol' click={onClickHandler} />
                        </div>
                        <div>
                            <label htmlFor="password" className="block mb-2 text-sm text-left  font-medium text-gray-900 dark:text-white">Ciudad</label>
